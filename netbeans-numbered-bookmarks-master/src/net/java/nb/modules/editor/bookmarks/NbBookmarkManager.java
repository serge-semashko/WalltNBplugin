...
import net.java.nb.lib.editor.bookmarks.spi.BookmarkManagerFactory;
...
public final class NbBookmarkManager implements BookmarkManager {
    ...
    static final String BOOKMARK_ANNOTATION_TYPE = "numbered-bookmark"; // NOI18N
...
//        Installer.addChangeListener(WeakListeners.change(bookmarksModuleListener, Installer.class));
...
//    public BookmarkImplementation createBookmarkImplementation(int lineStartOffset, String type, JTextComponent target, EditorCookie ec) {
//        throw new UnsupportedOperationException("Not supported yet.");
//    }
//    public BookmarkImplementation createBookmarkImplementation(int offset, String type, JTextComponent target) {
    public BookmarkImplementation createBookmarkImplementation(int offset, String type, JTextComponent target, EditorCookie ec) {
        return new NbBookmarkImplementation(this, offset, type, target, ec);
    }
