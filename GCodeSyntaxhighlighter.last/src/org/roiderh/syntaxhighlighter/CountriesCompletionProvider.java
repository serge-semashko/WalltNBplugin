...
@MimeRegistration(mimeType = "text/x-nc", service = CompletionProvider.class)
...
//                Document d1 = jtc.getDocument();
                ...
                Boolean setok = false;
                try {
                    log2("doc len =" + Integer.toString(jtc.getDocument().getLength())+"caretOffsetr"+Integer.toString(caretOffset));
...
//                                    log2("addsect");
                ...
                if (!setok) {
//                    completionResultSet.addItem(new CountriesCompletionItem("No suggestion", caretOffset));
