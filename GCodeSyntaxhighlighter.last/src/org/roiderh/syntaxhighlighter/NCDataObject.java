...
@Messages({
        "LBL_SJ_LOADER=Files of G-Code"
})
@MIMEResolver.ExtensionRegistration(
        displayName = "#LBL_SJ_LOADER",
        mimeType = "text/x-nc",
        extension = {"nc", "NC", "ANC", "anc", "cnc", "CNC", "gcode", "GCODE","wlt","WLT"})
@DataObject.Registration(
        mimeType = "text/x-nc",
        iconBase = "org/roiderh/syntaxhighlighter/NCIcon.png",
        displayName = "#LBL_SJ_LOADER",
        position = 300)
@ActionReferences({
        @ActionReference(
                path = "Loaders/text/x-nc/Actions",
                id
